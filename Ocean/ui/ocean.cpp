    ...
    , ui(new Ui::Ocean)
{
    ...
    //TTS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    if(Ocean::ownImage->load("/root/29614_original.jpg", "jpg", Qt::AutoColor))
        qDebug() << "true";
    else
        qDebug() << "false";
    ...
    //Image of playlist
    Ocean::imageOfPlayList->setPixmap(*imageTTS);
    Ocean::imageOfPlayList->setMinimumSize(200, 150);
    Ocean::imageOfPlayList->setMaximumSize(225, 200);
...
Ocean::~Ocean()
{
    ...
    if(sysmanager->PointerIsEmpty(getStringFromUser))
        qDebug() << "2) getStringFromUser empty!";
